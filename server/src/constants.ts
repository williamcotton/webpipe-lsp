...
export const KNOWN_MIDDLEWARE = new Set([
  'jq', 'pg', 'fetch', 'handlebars', 'lua', 'js', 'auth', 'cache', 'log', 'debug', 'validate', 'graphql', 'rateLimit', 'gg'
]);

export const KNOWN_STEPS = new Set([
  'jq', 'pg', 'fetch', 'handlebars', 'lua', 'js', 'auth', 'cache', 'log', 'debug', 'validate', 'result', 'pipeline', 'join', 'graphql', 'rateLimit', 'loader', 'gg'
]);
